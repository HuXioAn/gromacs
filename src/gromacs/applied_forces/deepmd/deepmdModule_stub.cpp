...
/*! \internal \file
 * \brief
 * Stub implementation of deepmdModule
 * Compiled in case if deepmd is not activated with CMake.
 *
 * \author 
 ...
 * \brief deepmd module
 *
 * Stub Implementation in case deepmd library is not compiled
 */
class deepmdMDModule final : public IMDModule
{
public:
    //! \brief Construct the deepmd module.
